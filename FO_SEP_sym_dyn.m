...
%     A_maxs =subs(A_max ,u,uS);
    ...
    matlabFunction(FF_med,A_med,'vars',{y,MP,U,g0,epsilon},'file',fullfile(dir_name,'FO_med_dz'));
    matlabFunction(FF_max,A_max,'vars',{y,MP,U,g0,epsilon},'file',fullfile(dir_name,'FO_max_dz'));
