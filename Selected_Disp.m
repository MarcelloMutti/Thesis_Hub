...
fsopt=optimoptions('fsolve','Display','iter-detailed','SpecifyObjectiveGradient',true,'OptimalityTolerance',1e-8,'FunctionTolerance',1e-8,'MaxIterations',2e3);
...
if isempty(tf)
    ...
    % lltf_g=[prob(id).y0(8:14); prob(id).tf_ad];
  %   lltf_g=[4.6069e+01
  % -7.6449e+00
  %  2.6702e+00
  %  2.0998e+01
